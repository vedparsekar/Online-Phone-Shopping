...
<head>
	...
	<title>Onlineshopping |Admin Manage admins   </title>
...
{				?>	
										<tr>
											...
											<td>
											<a href="manageadmins.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
