									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
<?php 
$sql3 ="SELECT catid from procategory ";
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Product Categories</div>
												</div>
											</div>
...
?>
											...
											<a href="emanageproduct.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
