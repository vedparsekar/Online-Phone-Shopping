...
<a href="prochangeimage.php?imgid=<?php echo htmlentities($result->pid)?>">Change Image 1</a>
</div>
<div class="col-sm-4">
Image 2 <img src="proimg/<?php echo htmlentities($result->picture1);?>" width="300" height="200" style="border:solid 1px #000">
<a href="prochangeimage1.php?imgid=<?php echo htmlentities($result->pid)?>">Change Image 1</a>
</div>
<div class="col-sm-4">
Image 3 <img src="proimg/<?php echo htmlentities($result->picture2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="prochangeimage2.php?imgid=<?php echo htmlentities($result->pid)?>">Change Image 1</a>
</div>
