...
<head>
	...
	<title>Online Shopping |Admin Manage Product   </title>
...
{				?>	
		...
		<td><a href="editproduct.php?id=<?php echo $result->pid;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<a href="emanageproduct.php?del=<?php echo $result->pid;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
