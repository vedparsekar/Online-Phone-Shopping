...
<div class="items">
	 ...
	 <h5>Phones</h5>
		 <div class="items-sec">
		 <?php
$sql = "SELECT * FROM product where catid=1 order by pid desc limit 4";
$result = $conn->query($sql);
...
echo'<div class="clearfix"></div><a href="product.php?id=1"><button type=button class="btn btn-xs">View all</button></a>
		  ...
		  echo '<br/><h5>Headphones</h5>
		 <div class="items-sec btm-sec">';		 
			 
$sql = "SELECT * FROM product where catid=2 order by pid desc limit 4";
$result = $conn->query($sql);
