...
$sql = "SELECT sum(total),count(pid) FROM user_cart where userid=$u and cartstatus=0";
...
echo "<br/><div align='center'><h3><span class='glyphicon glyphicon-ok-sign' style='color: #00c851;'></span> DONE</h3><br/><a href='index.php'><button type=button class='btn btn-xs'><span class='glyphicon glyphicon-circle-arrow-left'></span> BACK</button></a></div><br/>";
?>
